...
If you need to have a focusable-by-the-reader's HTML element (or the user can navigate to the content by tapping “Tab”) you need to make it this way. [Here is a simple guide](https://www.a11yproject.com/posts/how-to-use-the-tabindex-attribute/#:~:text=tabindex%20is%20a%20global%20attribute,via%20the%20keyboard%27s%20Tab%20key) on how to properly use tabindex.
...
If you still ask why you need a label, read this first.
...
- Hide it of assistive tech but keep it visually.
  Here is a cool snippet that tackles the issue.
...
At Potato we strive to create digital products and services that are accessible to everyone. Discover more about our product inclusion approach.
